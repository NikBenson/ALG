\section{Implementierung}
	...
	\subsection{Auswahl der Splitter}
		...
		Zunächst wird eine Sample, also eine Repr"asentative Teilmenge der gesamt Daten, gebildet.
		...
		\begin{figure}[h]
			...
			\end{center}
		\end{figure}\\
		Ist die Sample hinreichend repr"asentativ, so folgt daraus, dass die resultierenden Splitter die Daten in annähernd identisch große Buckets unterteilt.\\
