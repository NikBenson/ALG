\section{Implementierung}
	...
	\paragraph{Bucket}
		...
		\begin{figure}[h]
			...
			\end{center}
		\end{figure}\\
		Wichtig ist dabei, dass Elemente, die denselben Wert, wie ein Splitter haben, entweder in den Bucket links, oder rechts, von jenem, eingeordnet werden können.\\
