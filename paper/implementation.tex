\section{Implementierung}
	...
	\subsection{Auswahl der Splitter}
		...
		\subsubsection{Gleichmäßig}
			\label{sec:even}
			\lstinputlisting[language=C, caption=Auswahl der Sample in gleichmäßigen Schritten, label=fig:select_sample_even]{../code/src/samplesort/choose_sample/even.c}
		...
		\subsubsection{Semi-Zufällig}
			...
			\lstinputlisting[language=C, caption=Auswahl der Sample Semi-Zufällig, label=fig:select_sample_semi-random]{../code/src/samplesort/choose_sample/semi_random.c}
